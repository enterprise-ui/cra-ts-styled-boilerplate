...
function withController<C extends TReactComponentType<TProps>, TProps = {}>(TargetComponent: C): C {
    ...
    EnhancedComponent.displayName = `withController.(${TargetComponent.displayName || TargetComponent.name || 'TargetComponent'})`;
